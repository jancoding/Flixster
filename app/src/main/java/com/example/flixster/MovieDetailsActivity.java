...
//        rlDetails = findViewById(R.id.rlDetails);
        ...
        binding.rvReviews.addItemDecoration(new MovieDetailsActivity.VerticalSpaceItemDecoration(48));
        ...
        if (voteAverage/2.0f > 4) {
            ...
            binding.rlDetails.setBackgroundColor(Color.rgb(175, 235, 169));

        } else if (voteAverage/2.0f > 2.5) {
            Log.d("color", "IN HERE yellow");
            binding.rlDetails.setBackgroundColor(Color.rgb(224, 235, 127));
        } else {
            Log.d("color", "IN HERE red");
            binding.rlDetails.setBackgroundColor(Color.rgb(240, 129, 144));
        }
